...
class LeagueAdapter(private val context: Context, private val listener: (LeagueModel) -> Unit): RecyclerView.Adapter<LeagueAdapter.ViewHolder>(){

    private var leagues = ArrayList<LeagueModel>()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder = ViewHolder(LeageItemUI().createView(AnkoContext.Companion.create(parent.context)))
